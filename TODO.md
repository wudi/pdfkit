...
- [x] HTML/Markdown to PDF: Implement a layout engine that converts HTML/Markdown input into PDF pages using the `builder` API. Status: Done (implemented basic Markdown layout engine with headers, paragraphs, lists, and pagination in `layout` package).
